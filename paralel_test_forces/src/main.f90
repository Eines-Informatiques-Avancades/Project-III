...
!        real(8), parameter :: k_b = 1.380649e-23
   ...
   open (45, file="Forces0.dat")
   open (46, file="Forces1.dat")
   open (47, file="Forces2.dat")
   ...
   open (48, file="Forces3.dat")
   open (49, file="Forces4.dat")
   open (95, file="momentum.dat")
   open (97, file="Forces_desp.dat")
   open (98, file="posfinal.xyz")
   ...
   write (44, *) ""
   write (44, *) "dt = ", dt
   write (44, *) "#  time , pot, kin , total"
   write (95, *) "#  time , momentum"
   write (77, *) "#  time , Temp"
   ...
   do step = 1, Nsteps
      ...
      if (rank .eq. 0) then
       ...
       Pressure = (2*K_energy + Ppot)/(3*L**3)
         ...
         write (44, '(4F12.5)') step*dt, pot, K_energy, pot + K_energy
         write (95,*) step*dt, p
